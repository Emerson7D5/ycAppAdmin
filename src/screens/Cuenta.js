...
import { Images, tmTheme } from '../constants';
import { webApi, idStore } from '../constants/utils';
...
export default class Cuenta extends React.Component {
  ...
  async getData() {
    ...
    return fetch(webApi + '/account/info_account_store/' + this.state.user_store)
                  ...
                  <Block flex>
                    <Block flex style={styles.profileCard}>
                      <Block middle style={styles.avatarContainer}>
                        <Image
                          source={{ uri: this.state.dataStore[0][0].store_img }}
                          style={styles.avatar}
                        />
                      </Block>
                      <Block style={styles.info}>
                        <Block
                          ...
                          <Button
                            rounded
                            small
                            style={{ backgroundColor: tmTheme.COLORS.INFO }}
                            onPress={() => {
                              navigate(
                                'Ordenes',
                          ...
                          <Button
                            rounded
                            small
                            style={{ backgroundColor: tmTheme.COLORS.DEFAULT }}
                            onPress={() => {
                              navigate('Servicios');
                            }}>
                            <Text> Servicios</Text>
                        ...
                        <Block flex style={{ marginTop: 20 }}>
                          <Block middle style={styles.nameInfo}>
                            ...
                            <Block
                              middle
                              style={{ marginTop: -100, marginBottom: 16 }}>
                          ...
                          <Block middle style={{ marginTop: 10 }}>
                            ...
                            <Text style={{ textAlign: 'center' }}>
                              {this.state.dataStore[0][0].store_address}
                            </Text>
                          </Block>
