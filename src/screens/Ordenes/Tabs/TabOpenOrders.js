...
export default class TabOpenOrders extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        }
    ...
    render () {
        ...
        let content = this.props.dataOrder.map(function (dataContent, index) {
            ...
            if (dataContent.order_current_status === 'Order Placed' || dataContent.order_current_status === 'Order Accepted') {
