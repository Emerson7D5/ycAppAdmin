...
import {
    ...
    Button, Spinner, Textarea, Footer,
...
export default class OrdenCreada extends Component {
    ...
    componentDidMount() {
        ...
        this.listener = EventRegister.addEventListener('reloadOrdenCreada', (idOrder) => {
            
            this.setState({
                isLoading: true, 
                fetched: false, 
            });
            this.getData(idOrder);
    ...
    async getData(val) {
        ...
        return fetch(webApi + '/new_order/detail_order/' + val)
            .then((response) => response.json())
            .then((responseJson) => {

                this.setState({
                    dataContent: responseJson[0],
                    fetched: true,
                    isLoading: false, 
                });
    ...
    render() {
        ...
        else if (typeof this.props.route.params != 'undefined' && this.state.fetched == false) {
            
            this.getData(this.props.route.params.envio);
        }
        ...
        if (this.state.isLoading) {
            return (
                <View style={styles.container}>
                    <Spinner color='green' />
                    <Text>Cargando datos de nueva orden...</Text>
                </View>
            )
        }
        else if(this.state.isAccepting) {
            return (
                <View style={styles.container}>
            ...
            let fecha = DateFormat(this.state.dataContent.order_creation_date, "h:MMTT dd-mm-yyyy");
            ...
            return (
                ...
                <Container>
                     ...
                     <Content style={{backgroundColor: '#00B4AB'}}>
                        ...
                        <Text
                            ...
                            {this.state.dataContent.order_code}
                        </Text>
                        ...
                        <Text
                            ...
                            {this.state.dataContent.order_user_detail.user_fullname}
                        </Text>
                        ...
                        <Text
                            ...
                            {this.state.dataContent.order_user_detail.user_current_address.address_name}
                        </Text>
                        ...
                        <Block middle row>
                            ...
                            <Text
                                style={{
                                    ...
                                    <TimeAgo style={{ color: '#fff', marginLeft: 50}} time={this.state.dataContent.order_creation_date} />
                            </Text>
                        ...
                        <DetalleOrden dataOrder={this.state.dataContent.order_detail} {...this.props}/>
                            ...
                            <View style={{flex:1}}>
                                <View style={{backgroundColor: '#fff',margin:30, padding:10, borderRadius: 20, flex:0.75}}>
                                    ...
                                    <Button full rounded success style={{textAlign: "center", marginTop: 30}} 
                                        onPress={() => this.submit(this.state.dataContent._id)}
                                    >
                                        <Icon name="check" style={{ fontSize: 15, marginLeft: 10, color: '#fff' }}></Icon>
